		...
		<div class="center-table">
			<form action="#" id='registForm'>
				...
				<div class="content-panel clearfix pd-default">
					...
					<input type="text" class="input-text font-size-36 mg-default2 input-st1"  tabindex="3" name="USER_NAME" require="true" placeholder='${pb:msg(pageContext.request, "이름")}' >
					<input type="email" class="input-text font-size-36 mg-default2 input-st1" enter-exec='5' tabindex="4" name="EMAIL" require="true" placeholder='${pb:msg(pageContext.request, "이메일")}' >
					<button type="button" class="font-size-24 fl-right mg-rt-default2 btn btn-st1" tabindex="6" id='goBackBtn'>${pb:msg(pageContext.request, "뒤로")}</button>
